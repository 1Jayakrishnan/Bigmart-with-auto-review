...
MODEL_PATH = os.path.join(BASE_DIR, 'dl_models', 'model_dl.h5')
TOKENIZER_PATH = os.path.join(BASE_DIR, 'dl_models', 'tokenizer.pkl')
LABELENC_PATH = os.path.join(BASE_DIR, 'dl_models', 'labelencoder.pkl')
